...
namespace TeduShop.Data.Infrastructure
{
    public abstract class ReponsitoryBase<T> where T: class
    {
        ...
        protected IDbFactoty DbFactoty
        {
            get;
            private set;
        }
        ...
        {
            get { return dataContext ?? (dataContext = DbFactoty.Init()); }
        }
        #endregion
        ...
        {
            IEnumerable<T> Object = dbSet.Where<T>(where).AsEnumerable();
        ...
        public T GetSingelByCondition(Expression<Func<T, bool>> expression, string[] includes = null)
        {
